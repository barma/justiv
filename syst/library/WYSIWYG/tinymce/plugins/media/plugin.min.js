...
tinymce.PluginManager.add('media', function (editor, url) {
    ...
    function openmanager(types) {
        ...
        win = editor.windowManager.open({
            ...
            data: data,
            classes: 'filemanager',
            file: tinyMCE.baseURL + '/plugins/filemanager/dialog.php?type=' + types + '&editor=' + editor.id + '&lang=' + tinymce.settings.language,
            filetype: 'file',
            width: 900,
            height: 600,
            inline: 1
                    ...
                    items: [

                        {
                            ...
                            items: [
                                ...
                                {name: 'upl_video', type: 'button', classes: 'btn open', icon: 'browse', onclick: function () {
                                    openmanager(3)
                        ...
                        },
                        {
                            ...
                            items: [
                                ...
                                {name: 'upl_video1', type: 'button', classes: 'btn open', icon: 'browse', onclick: function () {
                                    openmanager(4)
                                }, tooltip: 'Select video'}
                            ]
                        },
                        {
                            ...
                            items: [
                                ...
                                {name: 'upl_video2', type: 'button', classes: 'btn open', icon: 'browse', onclick: function () {
                                    openmanager(5)
                                }, tooltip: 'Select video'}
                            ]
                        },
