...
$base_url = "http://barma/"; // base url of site. If you prefer relative urls leave empty
$upload_dir = '/media/'; // path from base_url to base of upload folder
$current_path = dirname(__FILE__) . '/'; // relative path from filemanager folder to upload folder
