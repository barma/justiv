...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        function n(r) {
            ...
            function o(o) {
                ...
                s.on("init", function () {
                    ...
                    }) : s.inline && (s.on("nodechange keyup", function () {
                    ...
                    s.selection.restoreRng && (s.selection.setRng(s.selection.restoreRng), s.selection.restoreRng = null), e != s && (e && e.fire("blur", {focusedEditor: s}), r.activeEditor = s, s.fire("focus", {blurredEditor: e}), s.focus(!1), r.focusedEditor = s)
        ...
        var c = n.DOM, u = o.explode, d = o.each, f = o.extend, p = 0, h, m = {majorVersion: "4", minorVersion: "0", releaseDate: "2013-08-08", editors: [], i18n: s, activeEditor: null, setup: function () {
            var e = this, t, n, i = "", o;
            ...
            function n() {
                function e(r) {
                    ...
                    if (r)return u(r, function (r) {
                        var a = {text: r.title, icon: r.icon, preview: !0};
                        if (r.items)a.menu = e(r.items); else {
                            var l = r.format || "custom" + t++;
                            r.format || (r.name = l, n.push(r)), a.textStyle = function () {
                                return s(l)
                            }, a.onclick = function () {
                                m(l)
                            }, a.onPostRender = function () {
                                var e = this, t = o.activeEditor;
                                e.parent().on("show", function () {
                                    e.disabled(!t.formatter.canApply(l)), e.active(t.formatter.match(l))
                                })
                            }
                        }
                        i.push(a)
