 ...
 * @method callback setLogger2(callback $logger)
 * @method callback setCacher2(callback $cacher)
 * @method string setIdentPrefix2($prx)
 * @method string setCachePrefix2($prx)
 */
