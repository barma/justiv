 ...
 * http://docs.jquery.com/UI
 */
jQuery.ui || (function (g) {
    var f = g.browser.mozilla && (parseFloat(g.browser.version) < 1.9);
    g.ui = {version: "1.8b1", plugin: {add: function (j, k, m) {
        var l = g.ui[j].prototype;
        for (var h in m) {
        ...
        return document.compareDocumentPosition ? i.compareDocumentPosition(h) & 16 : i !== h && i.contains(h)
    }, hasScroll: function (k, i) {
        if (g(k).css("overflow") == "hidden") {
            return false
        }
        ...
        return g.ui.isOverAxis(m, l, h) && g.ui.isOverAxis(i, k, j)
    }, keyCode: {BACKSPACE: 8, CAPS_LOCK: 20, COMMA: 188, CONTROL: 17, DELETE: 46, DOWN: 40, END: 35, ENTER: 13, ESCAPE: 27, HOME: 36, INSERT: 45, LEFT: 37, NUMPAD_ADD: 107, NUMPAD_DECIMAL: 110, NUMPAD_DIVIDE: 111, NUMPAD_ENTER: 108, NUMPAD_MULTIPLY: 106, NUMPAD_SUBTRACT: 109, PAGE_DOWN: 34, PAGE_UP: 33, PERIOD: 190, RIGHT: 39, SHIFT: 16, SPACE: 32, TAB: 9, UP: 38}};
    if (f) {
        var a = g.attr, d = g.fn.removeAttr, c = "http://www.w3.org/2005/07/aaa", e = /^aria-/, b = /^wairole:/;
        g.attr = function (i, h, j) {
            var k = j !== undefined;
            return(h == "role" ? (k ? a.call(this, i, h, "wairole:" + j) : (a.apply(this, arguments) || "").replace(b, "")) : (e.test(h) ? (k ? i.setAttributeNS(c, h.replace(e, "aaa:"), j) : a.call(this, i, h.replace(e, "aaa:"))) : a.apply(this, arguments)))
        };
        g.fn.removeAttr = function (h) {
            return(e.test(h) ? this.each(function () {
                this.removeAttributeNS(c, h.replace(e, ""))
            }) : d.call(this, h))
        }
    }
    g.fn.extend({_focus: g.fn.focus, focus: function (h, i) {
        ...
        return(/fixed/).test(this.css("position")) || !h.length ? g(document) : h
    }, zIndex: function (i) {
        if (i !== undefined) {
        ...
        var h = this[0];
        while (h && h.style) {
            if (h.style.zIndex !== "" && h.style.zIndex !== 0) {
                return +h.style.zIndex
            }
            h = h.parentNode
        }
        return 0
    }});
    g.extend(g.expr[":"], {data: function (k, j, h) {
        return !!g.data(k, h[3])
    }, focusable: function (i) {
        var j = i.nodeName.toLowerCase(), h = g.attr(i, "tabindex");
        ...
        return(isNaN(h) || h >= 0) && g(i).is(":focusable")
    }})
})(jQuery);
/*
...
(function (a) {
    ...
    a.extend(a.ui.draggable, {version: "1.8b1", eventPrefix: "drag"});
...
(function (a) {
    a.widget("ui.droppable", {options: {accept: "*", activeClass: false, addClasses: true, greedy: false, hoverClass: false, scope: "default", tolerance: "intersect"}, _create: function () {
    ...
    a.extend(a.ui.droppable, {version: "1.8b1", eventPrefix: "drop"});
...
(function (c) {
    c.widget("ui.resizable", c.ui.mouse, {options: {alsoResize: false, animate: false, animateDuration: "slow", animateEasing: "swing", aspectRatio: false, autoHide: false, containment: false, ghost: false, grid: false, handles: "e,s,se", helper: false, maxHeight: null, maxWidth: null, minHeight: 10, minWidth: 10, zIndex: 1000}, _create: function () {
    ...
    c.extend(c.ui.resizable, {version: "1.8b1", eventPrefix: "resize"});
...
(function (a) {
    ...
    a.extend(a.ui.selectable, {version: "1.8b1"})
})(jQuery);
(function (a) {
    ...
    a.extend(a.ui.sortable, {version: "1.8b1", eventPrefix: "sort"})
})(jQuery);
jQuery.effects || (function (g) {
    ...
    g.extend(g.effects, {version: "1.8b1", save: function (l, m) {
...
(function (a) {
    ...
    a.extend(a.ui.accordion, {version: "1.8b1", animations: {slide: function (j, h) {
...
(function (a) {
    a.widget("ui.autocomplete", {options: {minLength: 1, delay: 300}, _create: function () {
        var b = this;
        this.element.addClass("ui-autocomplete ui-widget ui-widget-content ui-corner-all").attr("autocomplete", "off").attr({role: "textbox", "aria-autocomplete": "list", "aria-haspopup": "true"}).bind("keydown.autocomplete",function (c) {
            var d = a.ui.keyCode;
            switch (c.keyCode) {
                case d.PAGE_UP:
        ...
        var b = this, d = a("<ul></ul>"), e = this.element.parent();
        a.each(c, function (f, g) {
            a("<li></li>").data("item.autocomplete", g).append("<a>" + g.label + "</a>").appendTo(d)
        });
        this.menu = d.addClass("ui-autocomplete-menu").appendTo(e).menu({focus: function (g, h) {
            var f = h.item.data("item.autocomplete");
            if (false !== b._trigger("focus", null, {item: f})) {
                b.element.val(f.value)
            }
        }, selected: function (g, h) {
            var f = h.item.data("item.autocomplete");
            if (false !== b._trigger("select", g, {item: f})) {
                b.element.val(f.value)
            }
            b.close(g);
            b.previous = b.element.val();
        ...
        }}).zIndex(this.element.zIndex() + 1).css({top: 0, left: 0}).position({my: "left top", at: "left bottom", of: this.element}).data("menu");
        ...
        return this.menu ? this.menu.element : a([])
    }});
...
(function (a) {
    a.widget("ui.menu", {_create: function () {
        var c = this;
        this.element.addClass("ui-menu ui-widget ui-widget-content ui-corner-all").attr({role: "menu", "aria-activedescendant": "ui-active-menuitem"}).click(function (d) {
            d.preventDefault();
            c.select()
        });
        var b = this.element.children("li").addClass("ui-menu-item").attr("role", "menuitem");
...
(function (d) {
    ...
    d.widget("ui.button", {options: {text: true, label: null, icons: {primary: null, secondary: null}}, _create: function () {
        ...
        var e = this, f = this.options, g = this.type === "checkbox" || this.type === "radio", h = "ui-state-hover" + (!g ? " ui-state-active" : "");
        if (f.label === null) {
        ...
        if (this.type === "checkbox") {
            ...
            if (this.type === "radio") {
                this.buttonElement.bind("click.button", function () {
                    ...
                    var j = e.element[0], i = j.name, k = j.form, l;
                    if (i) {
                        if (k) {
                            l = d(k).find("[name=" + i + "]")
                        } else {
                            l = d("[name=" + i + "]", j.ownerDocument).filter(function () {
                                return !this.form
                            })
                        }
                        l.not(j).map(function () {
...
(function ($) {
    ...
    $.extend(Datepicker.prototype, {markerClassName: "hasDatepicker", log: function () {
        ...
        offset.top -= Math.min(offset.top, (offset.top + dpHeight > viewHeight && viewHeight > dpHeight) ? Math.abs(offset.top + dpHeight + inputHeight * 2 - viewHeight) : 0);
        return offset
        ...
        if (this._datepickerShowing) {
            ...
            if ($.effects && $.effects[showAnim]) {
                ...
                inst.dpDiv[(showAnim == "slideDown" ? "slideUp" : (showAnim == "fadeIn" ? "fadeOut" : "hide"))]((showAnim ? duration : ""), postProcess)
            }
            if (!showAnim) {
                postProcess()
            }
...
(function (b) {
    ...
    b.widget("ui.dialog", {options: {autoOpen: true, buttons: {}, closeOnEscape: true, closeText: "close", dialogClass: "", draggable: true, hide: null, height: "auto", maxHeight: false, maxWidth: false, minHeight: 150, minWidth: 150, modal: false, position: "center", resizable: true, show: null, stack: true, title: "", width: 300, zIndex: 1000}, _create: function () {
        ...
        c.uiDialog.draggable({cancel: ".ui-dialog-content", handle: ".ui-dialog-titlebar", containment: "document", start: function (g) {
            d = e.height;
        ...
        var c = this, e = c.options, d = typeof f == "string" ? f : "n,e,s,w,se,sw,ne,nw";
        c.uiDialog.resizable({cancel: ".ui-dialog-content", containment: "document", alsoResize: c.element, maxWidth: e.maxWidth, maxHeight: e.maxHeight, minWidth: e.minWidth, minHeight: c._minHeight(), handles: d, start: function (g) {
            b(this).addClass("ui-dialog-resizing");
            c._trigger("resizeStart", g)
        }, resize: function (g) {
            c._trigger("resize", g)
        }, stop: function (g) {
        ...
        this.uiDialog.css({top: 0, left: 0}).position({my: e.join(" "), at: e.join(" "), offset: f.join(" "), of: window, collision: "fit"});
        if (!c) {
            this.uiDialog.hide()
        }
    ...
    b.extend(b.ui.dialog, {version: "1.8b1", uuid: 0, maxZ: 0, getTitleId: function (c) {
        return"ui-dialog-title-" + (c.attr("id") || ++this.uuid)
    }, overlay: function (c) {
        this.$el = b.ui.dialog.overlay.create(c)
    }});
    b.extend(b.ui.dialog.overlay, {instances: [], maxZ: 0, events: b.map("focus,mousedown,mouseup,keydown,keypress,click".split(","),function (c) {
            ...
            setTimeout(function () {
                if (b.ui.dialog.overlay.instances.length) {
                    b(document).bind(b.ui.dialog.overlay.events, function (e) {
                        var f = b(e.target).parents(".ui-dialog").css("zIndex") || 0;
                        return(f > b.ui.dialog.overlay.maxZ)
                    })
                }
            }, 1);
...
(function (f) {
    ...
    f.fn.position = function (i) {
        ...
        f.each(["my", "at"], function () {
            var o = (i[this] || "").split(" ");
            o = o.length == 1 ? c.test(o[0]) ? o.concat([g]) : d.test(o[0]) ? [e].concat(o) : [e, g] : o;
        ...
        return this.each(function () {
            ...
            f.each(["left", "top"], function (x, w) {
                (f.ui.position[n[x]] && f.ui.position[n[x]][w](p, {targetWidth: k, targetHeight: h, elemWidth: s, elemHeight: r, offset: m, my: i.my, at: i.at}))
            });
            (f.fn.bgiframe && u.bgiframe());
            u.offset(f.extend(p, {using: i.using}))
        })
    };
    f.ui.position = {fit: {left: function (h, i) {
        var j = h.left + i.elemWidth - f(window).width() - f(window).scrollLeft();
        h.left = j > 0 ? h.left - j : Math.max(0, h.left)
    }, top: function (h, i) {
        var j = h.top + i.elemHeight - f(window).height() - f(window).scrollTop();
        h.top = j > 0 ? h.top - j : Math.max(0, h.top)
    }}, flip: {left: function (i, j) {
        if (j.at[0] == "center") {
            return
        }
        var k = i.left + j.elemWidth - f(window).width() - f(window).scrollLeft(), h = j.my[0] == "left" ? -j.elemWidth : j.my[0] == "right" ? j.elemWidth : 0, l = -2 * j.offset[0];
        i.left += i.left < 0 ? h + j.targetWidth + l : k > 0 ? h - j.targetWidth + l : 0
    }, top: function (i, k) {
        if (k.at[1] == "center") {
            return
        }
        var l = i.top + k.elemHeight - f(window).height() - f(window).scrollTop(), h = k.my[1] == "top" ? -k.elemHeight : k.my[1] == "bottom" ? k.elemHeight : 0, j = k.at[1] == "top" ? k.targetHeight : -k.targetHeight, m = -2 * k.offset[1];
...
(function (a) {
    ...
    a.extend(a.ui.progressbar, {version: "1.8b1"})
})(jQuery);
(function (b) {
    var a = 5;
    b.widget("ui.slider", b.ui.mouse, {options: {animate: false, distance: 0, max: 100, min: 0, orientation: "horizontal", range: false, step: 1, value: 0, values: null}, _create: function () {
    ...
    b.extend(b.ui.slider, {version: "1.8b1", eventPrefix: "slide"})
})(jQuery);
(function (b) {
    var a = 0;
    ...
    b.extend(b.ui.tabs, {version: "1.8b1"});
