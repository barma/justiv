(function (a) {
    elFinder = function (d, g) {
        ...
        function e() {
            c(null, b.dialog.height() - b.view.tlb.parent().height() - (IE ? 47 : 32))
        }
...
(function (a) {
    elFinder.prototype.quickLook = function (l, b) {
        ...
        if (( navigator.platform.indexOf("Mac") != -1) || IE) {
        ...
        if (IE && !this.mimes["application/x-shockwave-flash"]) {
    ...
    elFinder.prototype.quickLook.prototype.plugins = {image: new function () {
        ...
        this.show = function (e, d) {
            ...
            if (e.mimes[d.mime] && d.hash == e._hash) {
                a("<img/>").hide().appendTo(e.media.show()).attr("src", d.url + (IE || isbrowser == 'opera' ? "?" + Math.random() : "")).load(function () {
...
(function (a) {
    elFinder.prototype.eventsManager = function (d, c) {
        ...
        this.pointer = "";
        this.init = function () {
            this.cwd.bind("click",function (h) {
                var g = a(h.target);
            ...
            }).bind(window.opera ? "click" : "contextmenu",function (h) {
            ...
            a(document).bind(isbrowser == 'Firefox' || isbrowser == 'opera' ? "keypress" : "keydown", function (h) {
            ...
            a(document).bind( isbrowser == 'opera' ? "keypress" : "keydown", function (g) {
                if (b.lock) {
                    return
                }
                switch (g.keyCode) {
            ...
            if (!this.fm.options.disableShortcuts) {
                a(document).bind("keydown", function (h) {
                    ...
                    switch (h.keyCode) {
                        case 8:
                            if (g && b.ui.isCmdAllowed("rm")) {
                                h.preventDefault();
                                b.ui.exec("rm")
                            }
                            break;
                        case 13:
                            if (b.ui.isCmdAllowed("select")) {
                                return b.ui.exec("select")
                            }
                            b.ui.execIfAllowed("open");
                            break;
                        case 46:
                            b.ui.execIfAllowed("rm");
                            break;
                        case 65:
                            if (g) {
                                h.preventDefault();
                        ...
                        case 85:
                            ...
                            break;
                        case 86:
                            g && b.ui.execIfAllowed("paste");
                            break;
                        case 88:
                            g && b.ui.execIfAllowed("cut");
                            break;
                        case 113:
                            b.ui.execIfAllowed("rename");
                            break
                    }
                })
            }
